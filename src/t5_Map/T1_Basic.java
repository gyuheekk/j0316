...
/*
 	Map계열자료구조 : 사전식 자료구조, Web에서의 JSON형식과 같다.
 	순서와 관계없다. 즉, '키'와 '값'으로 구성된 자료구조로, '키'가 중요한 역할을 한다.
 	중복 => '키'는 중복불가, '값'은 중복허용
 */
public class T1_Basic {
	public static void main(String[] args) {
		//HashMap<Integer, String> map = new HsahMap<Integer, String>();
		//Map<Integer, String> map = new HsahMap<Integer, String>();
